        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('mahasiswa.magang.search') ? 'active' : '' }}" href="{{ route('mahasiswa.magang.search') }}">Cari Lowongan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('mahasiswa.profile.*') ? 'active' : '' }}" href="{{ route('mahasiswa.profile.edit') }}">Profil</a>
                    </li>
