                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 shadow-sm">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="text-center">
                                                <p class="mb-0 fw-bold text-truncate" style="max-width: 180px;">
                                                    {{ $item->perusahaan->nama_perusahaan }}</p>
                                                @php
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <p class="card-text small text-muted mb-3">{{ Str::limit($item->deskripsi, 100) }}
                                        </p>
                                    ...
                                    <div class="card-footer bg-white border-top-0 text-center">
                                        <small class="text-muted d-block mb-2">Dibuka hingga
                    ...
                    @else
                        <div class="col-12">
                            <div class="alert alert-info text-center">
                                <p class="mb-0">Tidak ada lowongan magang yang ditemukan. Coba ubah filter pencarian Anda.
                                </p>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="company-info">
                        <div class="d-flex align-items-center mb-4">
                            <div class="company-logo me-3">
                                <img src="" id="modalCompanyLogo" class="rounded" width="80" height="80"
                                    alt="Logo Perusahaan">
                            </div>
                            <div>
                            ...
                            <div class="col-md-6">
                                ...
                                <ul class="list-unstyled">
                                    <li class="mb-2"><i class="bi bi-envelope me-2"></i> <span
                                            id="modalCompanyEmail"></span></li>
                                    <li class="mb-2"><i class="bi bi-telephone me-2"></i> <span
                                            id="modalCompanyPhone"></span></li>
                                    <li class="mb-2"><i class="bi bi-globe me-2"></i> <span
                                            id="modalCompanyWebsite"></span></li>
                                    <li class="mb-2"><i class="bi bi-geo-alt me-2"></i> <span
                                            id="modalCompanyAddress"></span></li>
                                </ul>
                            </div>
                        </div>
            ...
            $('.view-company-detail').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#viewAllPositionsBtn').attr('href',
                            `/mahasiswa/perusahaan/${perusahaanId}`);
                        ...
                        `;
                            ...
                            internshipHTML =
                                '<p class="text-muted">Tidak ada lowongan magang saat ini.</p>';
                        }
