                ...
                <div class="internship-form-wrapper">
                    ...
                    <form action="{{ route('mahasiswa.magang.apply.form', $magang->id) }}" method="POST"
                        ...
                        <div class="info-grid">
                            ...
                            <div class="form-group">
                                <label>NIM</label>
                                <input type="text" value="{{ Auth::user()->mahasiswa->nim ?? 'NIM belum diatur' }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label>Jurusan</label>
                                <input type="text"
                                    value="{{ Auth::user()->mahasiswa->jurusan ?? 'Jurusan belum diatur' }}" readonly>
                            </div>
                            <div class="form-group">
                                <label>Email</label>
